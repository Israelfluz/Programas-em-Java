...
public class Exercicio07 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Situação \t\t\t\tQuantidade \tPercetual");
		System.out.printf("1 - Necessidade de esfera \t\t%d \t\t%.2f%%\n", contador_sit_1, p1);
		System.out.printf("1 - Necessidade de limpeza \t\t%d \t\t%.2f%%\n", contador_sit_2, p2);
		System.out.printf("1 - Necessidade troca do cabo ou do conector \t\t%d \t\t%.2f%%\n", contador_sit_3, p3);
		System.out.printf("1 - Quebrado ou inutilizado \t\t%d \t\t%.2f%%1\n", contador_sit_4, p4);
		teclado.close();
		}
